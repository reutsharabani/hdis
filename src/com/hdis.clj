(ns com.hdis
  (:require [com.biffweb :as biff]
            [com.hdis.home :as home]
            [com.hdis.middleware :as mid]
            [com.hdis.ui :as ui]
            [com.hdis.worker :as worker]
            [com.hdis.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"com.hdis.*-test"))
